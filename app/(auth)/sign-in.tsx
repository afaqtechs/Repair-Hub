...
export default function SignInScreen() {
    ...
    return (
        ...
        <ScrollView
            className="flex-1 bg-white mb-24"
        ...
        >
            ...
            <View className="flex-1">
                ...
                <View className="rounded-3xl px-5 py-7 ">
                    ...
                    <View className=" border  border-gray-200 rounded-xl flex-row items-center px-4 mb-5">
                    ...
                    <View className=" border border-gray-200 rounded-xl flex-row items-center px-4 ">
                        <Ionicons
                    ...
                    <TouchableOpacity
                        className="bg-gray-100 border  border-gray-200 rounded-xl py-3 flex-1 mx-1 items-center"
