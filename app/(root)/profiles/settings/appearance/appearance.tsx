        ...
        <SafeAreaView className="flex-1 bg-bg dark:bg-bg-dark">
            ...
            <View className="px-4 pt-2 pb-3 bg-bg dark:bg-bg-dark">
                <View className="flex-row items-center">
                    <TouchableOpacity onPress={() => router.back()} activeOpacity={0.7} className="w-11 h-11 items-center justify-center rounded-2xl bg-card dark:bg-card-dark border border-border dark:border-border-dark"
                    >
                        <Ionicons name="arrow-back" size={24} color={isDark ? "#F8FAFC" : "#171A2B"} />
                    </TouchableOpacity>
                    <Text className="ml-2 text-[20px] font-manrope-semibold text-text dark:text-text-dark">Appearance</Text>
                </View>
            </View>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 30 }} className="flex-1 bg-bg dark:bg-bg-dark">
                        ...
                        {themes.map((theme, index) => {
                            ...
                            return (
                                <Pressable
                                    ...
                                    className={`
                                        flex-row items-center justify-between px-4 py-3.5 bg-card dark:bg-card-dark rounded-lg
