    ...
    ({
        ...
        return (
            ...
            >
                ...
                {/* Message row */}
                <View
                    className={`flex-row px-4 ${isMine
                        ? "justify-end"
                        : "justify-start"
                        }`}
                >
                    <View
                        className={`max-w-[80%] rounded-2xl px-4 py-1 ${isMine
                            ? "rounded-br-none bg-primary"
                            : "rounded-bl-none bg-primary/30"
                            }`}
                    >
                        {/* Message content + selection indicator */}
                        <View className="flex-row items-center">
                            ...
                            <View className="flex-shrink">
                                <Text
                                    className={`font-manrope text-[11px] leading-5 ${isMine
                                        ? "text-white"
                        ...
                        <View className="mt-1 flex-row items-center justify-end gap-1">
                            <Text
                                className={`font-manrope text-[9px] ${isMine
                                    ? "text-white/70"
                                    : "text-gray-400"
                                    }`}
                            >
...
export default function ChatScreen({
    ...
    const hasMarkedInitialReadRef =
        useRef(false);

    const markReadTimeoutRef =
        useRef<ReturnType<typeof setTimeout> | null>(
            null
        );
    ...
    const sendReadRef =
        useRef<
            ((lastReadAt: string) => Promise<void>) |
            null
        >(null);
    ...
    const [remoteLastReadAt, setRemoteLastReadAt] =
    ...
    const handlePressChats = useCallback(
        (messageId: string) => {
            setChatSelected((previous) => {
                if (previous.size === 0) {
                    return previous;
        ...
        >
            <View className="flex-1">
                        ...
                        <View className="flex-1 flex-row items-center gap-3">
                            ...
                            <View className="flex-1">
                                ...
                                <View className="mt-0.5 flex-row items-center">
                                    <View
                                        className={`mr-1.5 h-2 w-2 rounded-full ${isOnline
                                            ? "bg-green-500"
                                            : "bg-gray-500"
                                            }`}
                                    />
                ...
                {!isSelectionMode && (
                    ...
                    >
                        <View
                            className="border-t border-border bg-bg px-3 pt-2 dark:border-border-dark dark:bg-bg-dark"
                        ...
                        >
                            <View className="flex-row items-end rounded-3xl bg-card px-2 py-1.5 dark:bg-card-dark">
                                ...
                                <TouchableOpacity
                                    ...
                                    className={`h-10 w-10 items-center justify-center rounded-full ${text.trim() && !isSending
                                        ? "bg-primary"
