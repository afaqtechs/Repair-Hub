...
const SecurityAndPrivacy = () => {
    ...
    const renderPasswordInput = (
        ...
        <View className={`flex-col gap-1 ${!isLast ? 'border-b border-border/50 dark:border-border-dark/50 pb-4' : ''}`}>
            <Text className="text-sm font-manrope-semibold text-text dark:text-text-dark">
                {label}
            </Text>
            <View className="mt-1 bg-input dark:bg-input-dark rounded-xl flex-row items-center px-4">
                <Ionicons
        ...
        >
            ...
            >
                ...
                <View className="mt-6 px-4 py-3 bg-input dark:bg-input-dark/50 rounded-xl">
                    <View className="flex-row items-center gap-2">
                        <Ionicons name="lock-closed-outline" size={16} color={isDark ? "#94A3B8" : "#64748B"} />
