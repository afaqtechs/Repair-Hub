                ...
                >
                    ...
                    {editingGeneralInfo && technician ? (
                        ...
                        <View className="mb-6">
                            ...
                            <View className="bg-card dark:bg-card-dark px-5 py-4 rounded-lg">
                                <View className="flex-col gap-1 border-b border-border/30 dark:border-border-dark/30 pb-3">
                                    <Text className="text-base text-text dark:text-text-dark font-manrope-semibold">
                                        {technician?.first_name || ""} {technician?.last_name || ""}
                                    </Text>
                                    <Text className="text-xs font-manrope text-text-muted dark:text-text-darkMuted">
                                        Full Name
                                    </Text>
                                </View>
                        ...
                        <View className="mb-6">
                            ...
                            <View className="bg-card dark:bg-card-dark px-5 py-4 rounded-lg">
                                ...
                                {technician?.bio ? (
                                    ...
                                    <Text className="text-base text-text-muted dark:text-text-darkMuted font-manrope-medium">
                                        No bio provided
                                    </Text>
                                )}
                    ...
                    <View className="mb-6">
                        ...
                        <View className="bg-card dark:bg-card-dark px-5 py-4 rounded-lg">
                            <View className="flex-row justify-between items-center py-2 border-b border-border/30 dark:border-border-dark/30">
                    ...
                    <View className="mb-4">
                        ...
                        <View className="bg-card dark:bg-card-dark border border-red-500/30 rounded-lg overflow-hidden">
                            <TouchableOpacity
                    ...
                    {/* Footer Note */}
                    <View className="mt-2 px-4 py-3 bg-input/30 dark:bg-input-dark/30 rounded-xl">
